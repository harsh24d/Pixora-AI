    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <div className="flex items-center gap-3 my-3">
          ...
          <label
            htmlFor="fileInput"
            className="px-4 py-2 text-white bg-gradient-to-r from-[#417DF6] to-[#8E37EB] 
               rounded-lg shadow-md hover:from-[#2969e8] hover:to-[#8121e8]
        ...
        <textarea
          ...
          rows={4}
          type="text"
          className="w-full p-2 mt-2 outline-none text-sm rounded-md
