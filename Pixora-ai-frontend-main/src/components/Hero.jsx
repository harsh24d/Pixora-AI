...
const Hero = () => {
  ...
  return (
    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen "
      >
        <div className="text-center mb-6 mt-36">
          <h1
        ...
        hover:scale-102 active:scale-95 transition cursor-pointer"
          ...
          <button className="bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-102 active:95 trasnition cursor-pointer">
            watch demo
          </button>
        </div>

        <div className="flex items-center gap-4 mt-8 mx-auto text-gray-600">
          <img src={assets.user_group} alt="usergroup" className="h-8" />
          Trusted by 10k+ people
        </div>

        <div className="mt-20 overflow-hidden w-full relative max-w-5xl mx-auto select-none">
